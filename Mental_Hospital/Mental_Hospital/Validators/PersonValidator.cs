...
public class PersonValidator : AbstractValidator<Person>
{
    ...
    {
        RuleFor(x => x.Name).MinimumLength(2).WithMessage("Name should be at least 2 characters long.");
        RuleFor(x => x.Surname).MinimumLength(2).WithMessage("Surname should be at least 2 characters long.");
